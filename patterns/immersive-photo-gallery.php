...
<!-- wp:cover {"url":"<?php echo esc_url( $placeholder_bg ); ?>","dimRatio":50,"overlayColor":"contrast","isUserOverlayColor":true,"minHeight":300,"minHeightUnit":"px","contentPosition":"center center","sizeSlug":"large","metadata":{"categories":["immersive"],"patternName":"caes-theme/immersive-cover","name":"Immersive Cover"},"align":"full","layout":{"type":"constrained"}} -->
