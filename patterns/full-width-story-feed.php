...
<!-- wp:query {"query":{"perPage":"1","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"namespace":"core/posts-list","metadata":{"name":"Full Width Story Feed","categories":["story_feeds"],"patternName":"caes-hub/post-feature"},"align":"wide","className":"caes-hub-post-list-grid"} -->
