...
<!-- wp:group {"metadata":{"name":"Related Publications","categories":["story_feeds"],"patternName":"caes-hub/related-news"},"align":"wide","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"className":"is-style-caes-hub-section-heading"} -->
    ...
    <!-- wp:caes-hub/hand-picked-post {"postType":["publications"],"layout":{"allowOrientation":true,"columnCount":3,"minimumColumnWidth":null},"displayLayout":"grid","customGapStep":5,"className":"caes-hub-post-list-grid","style":{"spacing":{"blockGap":"var:preset|spacing|60"}}} -->
