...
<div class="wp-block-group"><!-- wp:caes-hub/primary-keyword {"showCategoryIcon":true,"enableLinks":false,"name":"caes-hub/primary-keyword","mode":"preview","className":"is-style-caes-hub-oswald-uppercase","style":{"border":{"right":{"color":"var:preset|color|contrast","width":"1px"},"top":[],"bottom":[],"left":[]},"spacing":{"padding":{"right":"var:preset|spacing|30"}}}} /-->
