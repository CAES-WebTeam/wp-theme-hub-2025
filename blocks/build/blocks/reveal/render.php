...
/**
 * Server-side rendering for the Reveal block - Single Sticky Container Approach
 *
 * Key Change: All backgrounds are now siblings in ONE sticky container.
 * This eliminates alignment issues and allows smooth opacity/transform transitions
 * without ever changing position modes.
 *
 * Structure:
 * .caes-reveal
 *   .reveal-backgrounds (position: sticky - sticks when block reaches top)
 *     .reveal-frame-background (position: absolute - all share same coordinate space)
 *     .reveal-frame-background
 *     ...
 *   .reveal-sections (provides scroll height)
...
<div <?php echo $wrapper_attributes; ?>>
	<?php
	// Output duotone SVG filters (placed at start, outside visible content)
	...
	<!-- Sections provide scroll height and contain content -->
