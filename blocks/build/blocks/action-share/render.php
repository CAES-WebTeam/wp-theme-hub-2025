...
<div data-wp-interactive="action-share" <?php echo \get_block_wrapper_attributes(); ?>
    ...
    <dialog
        ...
        <form method="dialog">
            <button type="submit" data-wp-on-async--click="actions.toggle" class="caes-hub-modal__close"><span class="sr-only">Close</span></button><button type="submit" data-wp-on-async--click="actions.toggle" class="caes-hub-modal__close"></button>
        </form>
        <div class="caes-hub-modal__content">
            ...
            <ul class="caes-hub-action-share__list">
                ...
                <li><button class="caes-hub-action-share-social__button caes-hub-action-share-pocket__button" data-wp-on-async--click="actions.shareOnPocket"><span class="sr-only">Share on Pocket</span></button></li>
            ...
            <div class="caes-hub-copy-url">
                <div class="caes-hub-form__input-button-container caes-hub-copy-url__container">
                    <input type="text" class="caes-hub-form__input caes-hub-copy-url__field" value="<?php echo esc_url(get_permalink()); ?>" readonly>
