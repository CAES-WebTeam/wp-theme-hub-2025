...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"caes-hub/reveal-frames","version":"0.1.0","title":"Reveal Frame","parent":["caes-hub/reveal"],"category":"media","description":"Container for content specific to a single frame.","textdomain":"caes-reveal","usesContext":["caes-hub/reveal-frames","caes-hub/reveal-overlayColor","caes-hub/reveal-overlayOpacity"],"attributes":{"frameIndex":{"type":"number","default":0},"frameId":{"type":"string","default":""},"frameLabel":{"type":"string","default":"Frame Content"}},"supports":{"html":false,"reusable":false,"lock":false},"editorScript":"file:./index.js","editorStyle":"file:./index.css","render":"file:./render.php"}');
