...
add_action('acf/include_fields', function () {
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'taxonomy',
				'instructions' => 'Synced from the personnel database.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'taxonomy' => 'person_department',
				'field_type' => 'select',
				'allow_null' => 1,
				'add_term' => 0,
				'save_terms' => 0,
			...
			array(
				...
				'label' => 'Program Area',
				'name' => 'personnel_program_area',
				'type' => 'taxonomy',
				'instructions' => 'Synced from the personnel database.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'taxonomy' => 'person_program_area',
				'field_type' => 'select',
				'allow_null' => 1,
				'add_term' => 0,
				'save_terms' => 0,
			...
			array(
				'key' => 'field_person_cpt_employee_group',
				'label' => 'Employee Group',
				'name' => 'personnel_employee_group',
				'type' => 'taxonomy',
				'instructions' => 'Synced from the personnel database.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'taxonomy' => 'person_employee_group',
				'field_type' => 'select',
				'allow_null' => 1,
				'add_term' => 0,
				'save_terms' => 0,
			...
			array(
				'key' => 'field_person_cpt_personnel_is_active',
				'label' => 'Is Active (Personnel)',
				'name' => 'is_active',
				'aria-label' => '',
				'type' => 'true_false',
				'instructions' => 'Set by the personnel database sync. Indicates whether this person is currently active in the CAES personnel system.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'message' => '',
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_person_cpt_elements_profile_url_fragment',
				'label' => 'Elements Profile URL Fragment',
				'name' => 'elements_profile_url_fragment',
				'type' => 'text',
				'instructions' => 'Synced automatically from Symplectic Elements. Used to construct the experts.uga.edu profile URL.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'default_value' => '',
			...
			array(
				'key' => 'field_person_cpt_elements_degrees',
				'label' => 'Degrees',
				'name' => 'elements_degrees',
				'type' => 'repeater',
				'instructions' => 'Synced automatically from Symplectic Elements. Only public degrees are imported.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'layout' => 'table',
				...
				'sub_fields' => array(
					array(
						'key' => 'field_person_cpt_degree_name',
						'label' => 'Degree',
						'name' => 'degree_name',
						'type' => 'text',
						'required' => 0,
					...
					array(
						'key' => 'field_person_cpt_degree_field_of_study',
						'label' => 'Field of Study',
						'name' => 'degree_field_of_study',
						'type' => 'text',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
					...
					array(
						'key' => 'field_person_cpt_degree_institution',
						'label' => 'Institution',
					...
					array(
						'key' => 'field_person_cpt_degree_state',
						'label' => 'State/Region',
						'name' => 'degree_state',
						'type' => 'text',
						'required' => 0,
					...
					array(
						'key' => 'field_person_cpt_degree_country',
						'label' => 'Country',
						'name' => 'degree_country',
						'type' => 'text',
						'required' => 0,
					...
					array(
						'key' => 'field_person_cpt_degree_year',
						'label' => 'Year',
						'name' => 'degree_year',
						'type' => 'text',
						'required' => 0,
			...
			array(
				'key' => 'field_person_cpt_elements_websites',
				'label' => 'Personal Websites',
				'name' => 'elements_websites',
				'type' => 'repeater',
				'instructions' => 'Synced automatically from Symplectic Elements. Public personal websites only.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'layout' => 'table',
				...
				'sub_fields' => array(
					array(
						'key' => 'field_person_cpt_website_label',
						'label' => 'Label',
						'name' => 'website_label',
						'type' => 'text',
						'required' => 0,
					...
					array(
						'key' => 'field_person_cpt_website_url',
						'label' => 'URL',
						'name' => 'website_url',
						'type' => 'url',
						'required' => 0,
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_person_cpt_tags',
				'label' => 'Tags',
				'name' => 'person_tags',
				'type' => 'taxonomy',
				'instructions' => 'Free-form tags for grouping people. Used by feed blocks and filtering. Add new tags by typing and selecting "Add new".',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array('width' => '', 'class' => '', 'id' => ''),
				'taxonomy' => 'person_tag',
